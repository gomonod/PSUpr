...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->chart1->Size = System::Drawing::Size(592, 140);
			...
			this->label2->Location = System::Drawing::Point(97, 179);
			...
			this->label4->Location = System::Drawing::Point(9, 234);
			...
			this->label5->Location = System::Drawing::Point(9, 262);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(194, 201);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(187, 227);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(166, 255);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(528, 397);
			...
			this->pictureBox1->Location = System::Drawing::Point(12, 279);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(592, 112);
			...
			this->ClientSize = System::Drawing::Size(616, 432);
			...
			this->Name = L"Form1";
			this->Text = L"Выполнил студент группы 23-КФ Серафимович А.А.";
		...
		//Проверка, что введены данные xn, xk, xh и их преобразование в переменные типа Double
			if ((textBox1->Text != "") && (textBox2->Text != "") && (textBox3->Text != ""))
			{
				...
				else
				{
					...
					while (x <= xk)
					{
						if (x <= 0) y = 2*x*pow(2.71,-x);
						else
							if (x > 0 && x < 5) y = pow(x-1,3)+cos(pow(x,3));
							else y = 2*sqrt(pow(x,4)*sin(pow(x,3)));
...
private: System::Void textBox2_Leave(System::Object^ sender, System::EventArgs^ e) {
	...
	//колличество запятых в строке (дабы избежать варианта 0, 2384, 1254, 1251 – это не число) 
	k = 0;
	//двигаем индексатор, если наше число отрицательно
	 if(str[t]=='-') t++;
	//число не может начинаться с запятой 
	if(str[t]==',') a=false; while(t<l)
	{
